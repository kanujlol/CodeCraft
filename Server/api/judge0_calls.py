...
def compile_code(source_code, lang_id, question_id):
    results = []
    ...
    try:
        ...
        # Get the testcases from the question object
        ...
        return {"results": results}  # Return the results as a dictionary (no JsonResponse here)
